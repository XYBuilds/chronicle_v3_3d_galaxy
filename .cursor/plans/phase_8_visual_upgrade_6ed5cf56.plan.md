...
- 在 [`docs/benchmarks/Phase 8 基线 P8.0 性能与 P8.4 准入.md`](../../docs/benchmarks/Phase%208%20基线%20P8.0%20性能与%20P8.4%20准入.md) 记录 Phase 8 基线数值（`视觉参数总表.md` 仍 Git 跟踪，见 `.cursorignore`）
...
- [`docs/benchmarks/Phase 8 基线 P8.0 性能与 P8.4 准入.md`](../../docs/benchmarks/Phase%208%20基线%20P8.0%20性能与%20P8.4%20准入.md) + [`视觉参数总表.md`](../../docs/project_docs/%E8%A7%86%E8%A7%89%E5%8F%82%E6%95%B0%E6%80%BB%E8%A1%A8.md)（uniform/常量；`.cursorignore`）

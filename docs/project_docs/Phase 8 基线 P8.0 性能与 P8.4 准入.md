...
- **Phase 8 文档回写（P8.6 同步，2026-04-27）**：《视觉参数总表》持续与源码对齐；《Tech Spec》/《Design Spec》/《数据特征工程与 3D 映射总表》已更新 P8.1–P8.4 双 mesh 与 `genre_hue`；`搜索与 select 态联合 spec 草案.md` 已落盘（**未**实装产品代码）。

...
const meta = {
  ...
  argTypes: {
    ...
    uLMax: { control: { type: 'range', min: 0.4, max: 1.0, step: 0.01 } },
    uHighRatingT: { control: { type: 'range', min: 0.5, max: 0.98, step: 0.01 } },
    uHighTierTRangeScale: { control: { type: 'range', min: 0.05, max: 1.0, step: 0.01 } },
    uLightnessRatingExponent: { control: { type: 'range', min: 0.5, max: 6, step: 0.05 } },
    uDistanceFalloffK: { control: { type: 'range', min: 0, max: 0.01, step: 1e-6 } },
    uDistanceFalloffMode: { control: { type: 'range', min: 0, max: 1, step: 1 } },
  ...
  args: {
    ...
    uDistanceFalloffK: 0.0001,
    uDistanceFalloffMode: 1,
    uChroma: 0.15,

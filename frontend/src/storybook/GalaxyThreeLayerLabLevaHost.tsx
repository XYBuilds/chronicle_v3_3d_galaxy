...
export function GalaxyThreeLayerLabLevaHost(props: GalaxyThreeLayerLabProps) {
  ...
  const [v, set] = useControls(
    ...
    () => ({
      ...
      uHighTierTRangeScale: {
        ...
        label: 'P10.1 · uHighTierTRangeScale',
        min: 0.05,
        max: 1.0,
        step: 0.01,
      },
      uLightnessRatingExponent: {
        value: props.uLightnessRatingExponent,
        label: 'P10.1 · uLightnessRatingExponent',
        min: 0.5,
        max: 6,
        step: 0.05,
      },
      uDistanceFalloffK: {
        value: props.uDistanceFalloffK,
        label: 'P10.2 · uDistanceFalloffK',
        min: 0,
        max: 0.01,
        step: 1e-6,
      },
  ...
  useEffect(() => {
    setRef.current?.({
      ...
      uActiveSizeMul: props.uActiveSizeMul,
      uBgSizeMul: props.uBgSizeMul,
      uLMin: props.uLMin,
      uLMax: props.uLMax,
      uHighRatingT: props.uHighRatingT,
      uHighTierTRangeScale: props.uHighTierTRangeScale,
      uLightnessRatingExponent: props.uLightnessRatingExponent,
      uDistanceFalloffK: props.uDistanceFalloffK,
      uDistanceFalloffMode: props.uDistanceFalloffMode === 1,
    ...
    props.zCurrent,
    props.zVisWindow,
    props.uActiveSizeMul,
    props.uBgSizeMul,
    props.uLMin,
    props.uLMax,
    props.uHighRatingT,
    props.uHighTierTRangeScale,
    props.uLightnessRatingExponent,
    props.uDistanceFalloffK,
    props.uDistanceFalloffMode,
    props.uChroma,
    props.uSizeScale,
  ...
  const merged: GalaxyThreeLayerLabProps = {
    ...
    uActiveSizeMul: v.uActiveSizeMul,
    uBgSizeMul: v.uBgSizeMul,
    uLMin: v.uLMin,
    uLMax: v.uLMax,
    uHighRatingT: v.uHighRatingT,
    uHighTierTRangeScale: v.uHighTierTRangeScale,
    uLightnessRatingExponent: v.uLightnessRatingExponent,
    uDistanceFalloffK: v.uDistanceFalloffK,
    uDistanceFalloffMode: v.uDistanceFalloffMode ? 1 : 0,
    uChroma: v.uChroma,

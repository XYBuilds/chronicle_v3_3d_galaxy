...
DEFAULT_OUTPUT = ROOT / "output" / "merged_movies_filtered_vote_count_gt_0.csv"
NULL_TOKENS = {"", "null", "none", "nan", "<na>"}


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Remove rows where vote_count is 0 or null-like."
    )
...
def main() -> None:
    ...
    print(f"Removed rows (vote_count == 0 or null-like): {removed:,}")
